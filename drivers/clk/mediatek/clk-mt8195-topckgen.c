...
const struct mtk_fixed_clk top_fixed_clks[] = {
	FIXED_CLK(CLK_TOP_IN_DGI, 0, 165000000),
	FIXED_CLK(CLK_TOP_ULPOSC1, 0, 248000000),
	FIXED_CLK(CLK_TOP_ULPOSC2, 0, 326000000),
	FIXED_CLK(CLK_TOP_MEM_466M, 0, 533000000),
	FIXED_CLK(CLK_TOP_MPHONE_SLAVE_B, 0, 49152000),
	FIXED_CLK(CLK_TOP_PEXTP_PIPE, 0, 250000000),
	FIXED_CLK(CLK_TOP_UFS_RX_SYMBOL, 0, 166000000),
	FIXED_CLK(CLK_TOP_UFS_TX_SYMBOL, 0, 166000000),
	FIXED_CLK(CLK_TOP_SSUSB_U3PHY_P1_P_P0, 0, 131000000),
	FIXED_CLK(CLK_TOP_UFS_RX_SYMBOL1, 0, 166000000),
	FIXED_CLK(CLK_TOP_FPC, 0, 50000000),
	FIXED_CLK(CLK_TOP_HDMIRX_P, 0, 594000000),
